...
TASK_FILE="${TASK_FILE:-eval/config/task_types_retrieval.json}"
...
DATASET_PROVIDER="${DATASET_PROVIDER:-deepseek}"
DATASET_MODEL="${DATASET_MODEL:-deepseek-v4-pro}"
...
POOLS_PER_GENERATION_CALL="${POOLS_PER_GENERATION_CALL:-1}"
